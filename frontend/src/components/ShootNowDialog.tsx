...
export const ShootNowDialog: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className="w-full max-w-md rounded-2xl bg-slate-800 border border-slate-600 shadow-2xl p-6 animate-fadeIn"
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            type="button"
            onClick={onLater}
            className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 text-slate-400 text-sm hover:text-slate-300"
          >
