...
| **ADK playground capture (Tier 2)** | [../runtime-proof/README.md](../runtime-proof/README.md) — mentor + triage delegation in dev UI (`playground-02a/b`, `playground-03*`); roster = `proof-05` |
